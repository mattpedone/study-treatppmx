...
load("output/simulation-scenarios/train-test/scen-alt-5/ma_pam_tt.RData");  
...
save(MOT, file="output/simulation-scenarios/train-test/scen-alt-5/mot_pam.RData")
save(MTUg, file="output/simulation-scenarios/train-test/scen-alt-5/mtug_pam.RData")
save(NPC, file="output/simulation-scenarios/train-test/scen-alt-5/npc_pam.RData")
