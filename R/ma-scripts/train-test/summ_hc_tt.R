...
load("output/simulation-scenarios/train-test/scen-alt-1/ma_hc_tt.RData");  
...
save(MOT, file="output/simulation-scenarios/train-test/scen-alt-1/mot_hc.RData")
save(MTUg, file="output/simulation-scenarios/train-test/scen-alt-1/mtug_hc.RData")
save(NPC, file="output/simulation-scenarios/train-test/scen-alt-1/npc_hc.RData")
