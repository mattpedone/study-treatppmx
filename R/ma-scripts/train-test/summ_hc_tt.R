...
load("output/simulation-scenarios/train-test/scen-alt-6/ma_hc_tt.RData");  
...
save(MOT, file="output/simulation-scenarios/train-test/scen-alt-6/mot_hc.RData")
save(MTUg, file="output/simulation-scenarios/train-test/scen-alt-6/mtug_hc.RData")
save(NPC, file="output/simulation-scenarios/train-test/scen-alt-6/npc_hc.RData")
