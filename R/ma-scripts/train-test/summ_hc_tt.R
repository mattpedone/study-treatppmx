...
load("output/simulation-scenarios/train-test/scen-alt-5/ma_hc_tt.RData");  
...
save(MOT, file="output/simulation-scenarios/train-test/scen-alt-5/mot_hc.RData")
save(MTUg, file="output/simulation-scenarios/train-test/scen-alt-5/mtug_hc.RData")
save(NPC, file="output/simulation-scenarios/train-test/scen-alt-5/npc_hc.RData")
