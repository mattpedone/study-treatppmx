...
load("output/simulation-scenarios/train-test/scen-alt-1/ma_km_tt.RData");  
...
save(MOT, file="output/simulation-scenarios/train-test/scen-alt-1/mot_km.RData")
save(MTUg, file="output/simulation-scenarios/train-test/scen-alt-1/mtug_km.RData")
save(NPC, file="output/simulation-scenarios/train-test/scen-alt-1/npc_km.RData")
